...
type ('this, 'env) idx_visitor_vtable =
     {
       ...
       visit_UVarBS : 'this -> 'env -> bsort UVarI.uvar_bs -> T.bsort,
       ...
       visit_UVarI : 'this -> 'env -> (bsort, idx) UVarI.uvar_i * region -> T.idx,
       ...
       visit_UVarS : 'this -> 'env -> (bsort, sort) UVarI.uvar_s * region -> T.sort,
       ...
       visit_uvar_bs : 'this -> 'env -> bsort UVarI.uvar_bs -> T.bsort T.UVarI.uvar_bs,
