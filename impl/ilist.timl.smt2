...
(assert (<= 0 n1))
(declare-const _0 Real)
(assert (<= 0 _0))
(declare-const _ Real)
(assert (<= 0 _))
...
;; (assert (not (<= (+ 5 (+ (* (+ m 3) n) (* 4 (* (+ m 3) (* n (log2 n1)))))) (* 4 (* (+ m 3) (* n (log2 n)))))))
;; (assert (not (<= (+ 5 (* (+ m 3) n)) (* 4 (* (+ m 3) (* n (log2 (+ 1 (/ n2 n1)))))))))
;; (assert (not (<= (+ (/ 5 (+ m 3)) n) (* 4 (* n (log2 (+ 1 (/ n2 n1))))))))
(assert (not (<= (+ (/ 5 (* (+ m 3) n)) 1) (* 4 (log2 (/ n n1))))))
;; (assert (not (<= (+ (/ 5 (* (+ m 3) n)) 1) (* 4 (log2 (+ 1 (/ n2 n1)))))))
;; (assert (<= (/ 3 2) (+ 1 (/ n2 n1))))
;; (assert (not (<= 0.58496 (log2 (/ 3 2)))))
(assert (<= 0.58496 (log2 (/ 3 2))))
;; (assert (not (<= (+ (/ 5 (* 4 (* (+ m 3) n))) (/ 1 4)) (log2 (+ 1 (/ n2 n1))))))
