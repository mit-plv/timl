...
fun str_mt (ctx as (sctx, kctx)) (t : mty) : string =
  case t of
...
type constr_core = (sort, string, mty * idx list) ibinds
type constr_decl = string * constr_core * other
type constr = var * string list * constr_core

type return = mty option * idx option
