...
struct
  ...
  fun test () =
    let
      ...
      val tm7_deriv = TyDerivPack (tm7_rel, KdDerivExists ((tm7_ctx, CstrExists (KdNat, CstrTypeNat (CstrVar 0)), KdProper), KdWfDerivNat (tm7_ctx, KdNat), KdDerivTypeNat ((BdKind KdNat :: tm7_ctx, CstrTypeNat (CstrVar 0), KdProper), KdDerivVar (tm7_ctx, CstrVar 2, KdNat))), KdDerivVar (tm7_ctx, CstrVar 2, KdNat), TyDerivVar (tm7_ctx, TmVar 1, CstrTypeNat (CstrVar 2), CstrTime "0.0"))
