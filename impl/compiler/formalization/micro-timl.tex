...
\scriptsize
\begin{array}{l}
	(\mathcal{K}; \mathcal{T}; \Sigma; p) \vdash e : \tau \triangleright i \mid (m, h, q) \hspace{1em}
	...
	\infer[\textsc{TyAbs}]{\jtygc{ \mathcal{C}}{ \lambda x:\tau. e}{ \tau \xrightarrow[m,h,q,r]{i} \tau_1 }{ 0 }{ 1 + |FV(e)\setminus \{ x \}| }{\mathcal{C}.4 + 1 + |FV(e)\setminus\{x\}|}{1 + |FV(e) \setminus \{x\}|} }{\mathcal{C}.1 \vdash \tau :: \star(s) & \mathcal{T}'=\mathcal{C}.2 \downarrow_{FV(e) \setminus \{x\}} & \jtygc{(\mathcal{C}.1;\mathcal{T}',x:\tau;\mathcal{C}.3; 0)}{ e }{ \tau_1 }{ i }{ m }{h}{q} & r = 1 + |FV(e)\setminus \{x\}| + \Phi_{\mathcal{C}.1}(\mathcal{T}')} \\
	
	\infer[\textsc{TyApp}]{\jtygc{\mathcal{C}} { e_1~e_2 } { \tau_2 } { i_1 + i_2 + 1 + i } { m_1 + m_2 + m }{ \max(h_1,h_2,\mathcal{C}.4+q_1+q_2+h) }{q_1+q_2+q} }{\jtygc{\mathcal{C}} { e_1 }{ \tau_1 \xrightarrow[m,h,q,r]{i} \tau_2 }{ i_1 }{ m_1 }{h_1}{q_1} & \jtygc{(\mathcal{C}.1;\mathcal{C}.2;\mathcal{C}.3;\mathcal{C}.4+q_1) } { e_2 }{ \tau_1 }{ i_2 }{ m_2}{h_2}{q_2}} \\
	...
	\infer[\textsc{TyInl}]{\jtygc{\mathcal{C} }{ \mathbf{l}.e }{ \tau_1 + \tau_2 }{ i }{ m}{h}{q}}{\jtygc{\mathcal{C} }{ e }{ \tau_1 }{ i }{ m }{h}{q} & \mathcal{C}.1 \vdash \tau_1 :: \star(s) & \mathcal{C}.1 \vdash \tau_2 :: \star(s)} \\
	
	\infer[\textsc{TyInr}]{\jtygc{\mathcal{C} }{ \mathbf{r}.e }{ \tau_1 + \tau_2 }{ i }{ m}{h}{q}}{\jtygc{\mathcal{C} }{ e }{ \tau_2 }{ i }{ m }{h}{q} & \mathcal{C}.1 \vdash \tau_2 :: \star(s) & \mathcal{C}.1 \vdash \tau_1 :: \star(s)} \\
	...
	\infer[\textsc{TyFold}]{\jtygc{\mathcal{C} }{ \mathbf{fold}~e }{ \tau~\vec{c} }{ i }{ m}{h}{q} }{\mathcal{C}.1 \vdash \tau~\vec{c} :: \star(s) & \tau = \mu \alpha :: \kappa. \tau_1 & \jtygc{\mathcal{C} }{ e }{\tau_1[\tau/\alpha]~\vec{c} }{ i }{ m}{h}{q} } \\
	...
	\infer[\textsc{TyPack}]{\jtygc{\mathcal{C} }{ \mathbf{pack}\langle c \mid e \rangle }{ \exists \alpha :: \kappa. \tau }{ i }{ m}{h}{q} }{\mathcal{C}.1 \vdash \exists \alpha :: \kappa. \tau :: \star(s) & \mathcal{C}.1 \vdash c :: \kappa & \jtygc{\mathcal{C} }{ e }{ \tau[c/\alpha] }{ i }{ m}{h}{q}} \\
	...
	\infer[\textsc{TyAbsC}]{\jtygc{\mathcal{C} }{ \Lambda \alpha :: \kappa. e }{\forall \alpha :: \kappa. \tau }{ 0 }{ m}{h}{q} }{\mathcal{C}.1 \vdash \mathrm{wf}~\kappa & \vdash \mathrm{value}~e & \jtygc{\mathcal{C},\alpha :: \kappa }{ e }{ \tau }{ 0 }{ m }{h}{q} & \mathcal{C}.1,\alpha :: \kappa \vdash \tau :: \star(s) & m,h,q,s~\mathrm{do~not~contain}~\alpha} \\
	...
	\infer[\textsc{TyRec}]{\jtygc{\mathcal{C} }{ \mathbf{rec}_\tau~x. e }{ \tau }{ 0 }{1 + |FV(e) \cup \{x\}| }{ \mathcal{C}.4+1+|FV(e)\cup\{x\}| }{1+|FV(e)\cup\{x\}|} }{e = \Lambda \overrightarrow{\alpha :: \kappa}. \lambda y : \tau_y. e_1 & \tau = \forall \overrightarrow{\alpha :: \kappa}. \tau_y \xrightarrow[m,h,q,r]{i} \tau_1 & \mathcal{C}.1 \vdash \tau :: \star(r) & \jtygc{ (\mathcal{C}.1,\overrightarrow{\alpha::\kappa};\mathcal{C}.2 \downarrow_{FV(e) \setminus \{x\}},x:\tau,y:\tau_y;\mathcal{C}.3;0) }{ e_1 }{ \tau_1 }{ i }{ m}{h}{q} & r = \cdots } \\
	...
	\infer[\textsc{TyNew}]{\jtygc{\mathcal{C} }{ \mathbf{new}~e_1~e_2 }{ \mathbf{arr}~\tau~j }{ i_1 + i_2 }{ m_1 + m_2 + j}{\max(h_1,h_2,\mathcal{C}.4+q_1+q_2+j) }{q_1+q_2+j} }{\jtygc{\mathcal{C} }{ e_1 }{\tau }{ i_1 }{ m_1}{h_1}{q_1}  & \jtygc{(\mathcal{C}.1;\mathcal{C}.2;\mathcal{C}.3;\mathcal{C}.4+q_1) }{ e_2 }{ \mathbf{nat}~j }{ i_2 }{ m_2}{h_2}{q_2} } \\
	
	\infer[\textsc{TyRead}]{\jtygc{\mathcal{C} }{ e_1[e_2] }{ \tau }{ i_1 + i_2 }{ m_1 + m_2}{\max(h_1,h_2,\mathcal{C}.4+q_1+q_2)}{s} }{\jtygc{\mathcal{C} }{ e_1 }{ \mathbf{arr}~\tau~j_1 }{ i_1 }{ m_1}{h_1}{q_1} & \jtygc{(\mathcal{C}.1;\mathcal{C}.2;\mathcal{C}.3;\mathcal{C}.4+q_1) }{ e_2 }{ \mathbf{nat}~j_2 }{ i_2 }{ m_2}{h_2}{q_2} & \mathcal{C}.1 \vdash j_2 <_n j_1 & \mathcal{C}.1 \vdash \tau :: \star(s) } \\
	...
	\infer[\textsc{TyLoc}]{\jtygc{\mathcal{C}}{\ell}{\tau}{0}{0}{\mathcal{C}.4}{1+s} }{ \mathcal{C}.3(\ell) = \tau & \mathcal{C}.1 \vdash \tau :: \star(s) }
