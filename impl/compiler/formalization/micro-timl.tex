...
\begin{array}{l}
	...
	\infer[\textsc{TyApp}]{\jtygc{\mathcal{C}} { e_1~e_2 } { \tau_2 } { i_1 + i_2 + 1 + i } { m_1 + m_2 + m }{ \max(h_1,h_2,\mathcal{C}.4+q_1+q_2+h) }{q} }{\jtygc{\mathcal{C}} { e_1 }{ \tau_1 \xrightarrow[m,h,q,r]{i} \tau_2 }{ i_1 }{ m_1 }{h_1}{q_1} & \jtygc{(\mathcal{C}.1;\mathcal{C}.2;\mathcal{C}.3;\mathcal{C}.4+q_1) } { e_2 }{ \tau_1 }{ i_2 }{ m_2}{h_2}{q_2}} \\
