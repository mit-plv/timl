functor MtypeVisitorFn (structure S : EXPR
                     structure T : EXPR
                    ) = struct
  ...
  let
    ...
    fun visit_EUnOp this env data =
      let
        val vtable = cast this
        val (opr, e, r) = data
        val e = #visit_mtype vtable this env e
      in
        T.EUnOp (opr, e, r)
      end
    fun visit_EBinOp this env data =
      let
        val vtable = cast this
        val (opr, e1, e2) = data
        val e1 = #visit_mtype vtable this env e1
        val e2 = #visit_mtype vtable this env e2
      in
        T.EBinOp (opr, e1, e2)
      end
    fun visit_ETriOp this env data =
      let
        ...
        val e1 = #visit_mtype vtable this env e1
        val e2 = #visit_mtype vtable this env e2
        val e3 = #visit_mtype vtable this env e3
      in
    ...
    fun visit_EAbs this env data =
      let
        val vtable = cast this
        val data = visit_bind (#visit_ptrn vtable this) (#visit_mtype vtable this) env data
      in
        T.EAbs data
      end
    ...
    fun visit_EAbsI this env data =
      let
        val vtable = cast this
        val (bind, r) = data
        val bind = visit_ibind_anno this (#visit_sort vtable this) (#visit_mtype vtable this) env bind
      in
        T.EAbsI (bind, r)
      end
    ...
    fun visit_ECase this env data =
      let
        ...
        val binds = map (visit_bind (#visit_ptrn vtable this) (#visit_mtype vtable this) env) binds
      in
    ...
    fun visit_ELet this env data =
      let
        ...
        val return = visit_return this env return
        val bind = visit_bind (visit_tele (#visit_decl vtable this)) (#visit_mtype vtable this) env bind
      in
    ...
    fun visit_DVal this env data =
      let
        ...
        val bind = visit_outer (visit_bind (visit_list (visit_tbinder this)) (#visit_mtype vtable this)) env bind
      in
        T.DVal (name, bind, r)
      end
    fun visit_DValPtrn this env data =
      let
        ...
        val e = visit_outer (#visit_mtype vtable this) env e
      in
        T.DValPtrn (pn, e, r)
      end
            ...
            visit_inner (
              visit_bind (visit_pair (visit_list (visit_tbinder this))
                         ...
                         (visit_pair (visit_pair (#visit_mtype vtable this)
                                     ...
                                     (#visit_mtype vtable this))) env bind
      in
        T.DRec (name, bind, r)
      end
