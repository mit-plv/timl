...
(*  
  ...
  Proof.
    ...
    eapply interp_prop_eq_refl'; eauto.
  Qed.
  
  Lemma interp_prop_ground_truth L : forall p, interp_prop [] p -> interp_prop L p.
  Proof.
    unfold interp_prop.
    induct L; intros p Hp; cbn in *; eauto.
    rename a into k.
    eapply forall_all_imply_elim; eauto.
    rewrite fuse_lift2_lift1.
