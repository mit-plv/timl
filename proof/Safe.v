...
Admitted.
  ...
  Proof.
    ...
    }
    {
      f_equal.
      {
        eapply H; eauto with db_la.
      }
      rewrite (H0 (S x) (S y)); repeat f_equal; eauto with db_la.      
    }
    {
      f_equal.
      {
    ...
    }
    {
      ...
      replace (S (y - n1)) with (S y - n1) by linear_arithmetic.
      eapply H0; eauto with db_la.
    }
  Qed.
  ...
  Lemma subst_c_c_k_p_shift_hit v :
    (forall b x n y,
        x + n <= y ->
