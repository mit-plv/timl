        ...
        }
        {
          ...
          Lemma shift_c_kinding2_wfkind2_wfprop2 :
            (forall G c k,
                kinding2 G c k ->
                forall G1,
                  kinding2 (G1 ++ G) (shift_c_c (length G1) 0 c) k) /\
            (forall G k,
                wfkind2 G k ->
                forall G1,
                  wfkind2 (G1 ++ G) (shift_c_k (length G1) 0 k)) /\
            (forall G p,
                wfprop2 G p ->
                forall G1,
                  wfprop2 (G1 ++ G) (shift_c_p (length G1) 0 p)).
          Proof.
