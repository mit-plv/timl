...
This soundness of the type system is proved using the Logical Step-indexed Logical Relation. We formalize our design and proof in the Coq proof assistant (in progress). Key technical contributions include:

\begin{itemize}
\item Recognizing the number of unfold-fold reductions as the only relevant metric in asymptotic complexity counting;
